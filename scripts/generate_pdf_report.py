...
class NumberedCanvas(canvas.Canvas):
    ...
    def draw_page_decorations(self, page_count):
        ...
        if self._pageNumber > 1:
            self.drawString(
                54, 750, "Brain Tumor MRI Classifier — Technical & Clinical Evaluation Report"
            )
...
def build_pdf(filename="Brain_Tumor_Classifier_Report.pdf"):
    doc = SimpleDocTemplate(
        filename, pagesize=letter, leftMargin=54, rightMargin=54, topMargin=54, bottomMargin=54
    )
    ...
    table_cell_bold = ParagraphStyle(
        "TableCellBold", parent=table_cell, fontName="Helvetica-Bold", textColor=PRIMARY
    )
    table_cell_header = ParagraphStyle(
        "TableCellHeader", parent=table_cell, fontName="Helvetica-Bold", textColor=colors.white
    )
    ...
    meta_data = [
        [
            ...
            Paragraph(
                '<b>Macro ROC-AUC:</b> <font color="#0D9488"><b>98.12%</b></font>', table_cell
            ),
        ],
        [
            ...
            Paragraph(
                '<b>Test Accuracy:</b> <font color="#0284C7"><b>93.0%</b></font>', table_cell
            ),
        ],
    ]
    ...
    class_desc_data = [
        ...
        [
            ...
            Paragraph(
                "Primary intra-axial tumors from glial tissue (astrocytomas, glioblastomas). Appears as infiltrative masses with irregular margins and edema.",
                table_cell,
            ),
            Paragraph(
                "High malignant potential; requires rapid neurosurgical resection and adjuvant chemo-radiation.",
                table_cell,
            ),
        ],
        [
            ...
            Paragraph(
                "Extra-axial tumors arising from arachnoid cap cells. Typically dural-based, well-demarcated with uniform contrast enhancement.",
                table_cell,
            ),
            Paragraph(
                "Most common primary brain tumor; causes compressive focal neurological deficits and seizures.",
                table_cell,
            ),
        ],
        [
            ...
            Paragraph(
                "Sellar and parasellar adenomas originating from the pituitary gland at the base of the brain.",
                table_cell,
            ),
            Paragraph(
                "Triggers endocrine syndromes and visual field loss via optic chiasm compression.",
                table_cell,
            ),
        ],
        [
            ...
            Paragraph(
                "Healthy brain parenchyma showing anatomical symmetry, normal sulcal patterns, and clear ventricles.",
                table_cell,
            ),
            Paragraph(
                "Crucial negative control preventing false-positive diagnostic alarms.", table_cell
            ),
        ],
    ]
    ...
    ds_split_data = [
        ...
        [
            Paragraph("Glioma", table_cell),
            Paragraph("1,190", table_cell),
            Paragraph("210", table_cell),
            Paragraph("400", table_cell),
            Paragraph("1,800", table_cell_bold),
        ],
        [
            Paragraph("Meningioma", table_cell),
            Paragraph("1,190", table_cell),
            Paragraph("210", table_cell),
            Paragraph("400", table_cell),
            Paragraph("1,800", table_cell_bold),
        ...
        [
            Paragraph("Pituitary", table_cell),
            Paragraph("1,190", table_cell),
            Paragraph("210", table_cell),
            Paragraph("400", table_cell),
            Paragraph("1,800", table_cell_bold),
        ...
        [
            Paragraph("<b>Total Distribution</b>", table_cell_bold),
            Paragraph("<b>4,760</b>", table_cell_bold),
            Paragraph("<b>840</b>", table_cell_bold),
            Paragraph("<b>1,600</b>", table_cell_bold),
            Paragraph("<b>7,200</b>", table_cell_bold),
        ],
    ]
    ...
    arch_data = [
        [
            Paragraph("<b>Layer / Block</b>", table_cell_header),
            Paragraph("<b>Output Shape</b>", table_cell_header),
            Paragraph("<b>Parameters</b>", table_cell_header),
            Paragraph("<b>Training Mode & Function</b>", table_cell_header),
        ],
        [
            Paragraph("Input Layer", table_cell),
            Paragraph("(128, 128, 3)", table_cell),
            Paragraph("0", table_cell),
            Paragraph("Axial MRI slice (RGB 3-channel)", table_cell),
        ],
        [
            Paragraph("VGG16 Blocks 1–4 (10 convs)", table_cell),
            Paragraph("(8, 8, 512)", table_cell),
            Paragraph("7,894,464", table_cell),
            Paragraph("<b>Frozen</b> (Pretrained ImageNet weights)", table_cell),
        ],
        [
            Paragraph("VGG16 Block 5 (3 convs)", table_cell),
            Paragraph("(4, 4, 512)", table_cell),
            Paragraph("7,079,424", table_cell),
            Paragraph("<b>Trainable</b> (Fine-tuning deep domain features)", table_cell),
        ],
        [
            Paragraph("Flatten", table_cell),
            Paragraph("(8192)", table_cell),
            Paragraph("0", table_cell),
            Paragraph("Spatial feature flattening", table_cell),
        ],
        [
            Paragraph("Dropout (Rate = 0.3)", table_cell),
            Paragraph("(8192)", table_cell),
            Paragraph("0", table_cell),
            Paragraph("Regularization (prevents co-adaptation)", table_cell),
        ],
        [
            Paragraph("Dense (ReLU)", table_cell),
            Paragraph("(128)", table_cell),
            Paragraph("1,048,704", table_cell),
            Paragraph("<b>Trainable</b> (Non-linear representation)", table_cell),
        ],
        [
            Paragraph("Dropout (Rate = 0.2)", table_cell),
            Paragraph("(128)", table_cell),
            Paragraph("0", table_cell),
            Paragraph("Overfitting prevention", table_cell),
        ],
        [
            Paragraph("Dense Output (Softmax)", table_cell),
            Paragraph("(4)", table_cell),
            Paragraph("516", table_cell),
            Paragraph("<b>Trainable</b> (Class probability distribution)", table_cell),
        ],
        [
            Paragraph("<b>Total Model Summary</b>", table_cell_bold),
            Paragraph("<b>4-Class Softmax</b>", table_cell_bold),
            Paragraph("<b>15,027,524 Total</b>", table_cell_bold),
            Paragraph("<b>7,133,060 Trainable Params</b>", table_cell_bold),
        ],
    ]
    ...
    metrics_data = [
        ...
        [
            Paragraph("<b>Glioma</b>", table_cell),
            Paragraph("0.97", table_cell),
            Paragraph("0.77", table_cell),
            Paragraph("0.86", table_cell),
            Paragraph("<b>0.9429</b>", table_cell_bold),
            Paragraph("400", table_cell),
        ],
        [
            Paragraph("<b>Meningioma</b>", table_cell),
            Paragraph("0.83", table_cell),
            Paragraph("0.97", table_cell),
            Paragraph("0.89", table_cell),
            Paragraph("<b>0.9841</b>", table_cell_bold),
            Paragraph("400", table_cell),
        ],
        [
            Paragraph("<b>No Tumor</b>", table_cell),
            Paragraph("0.94", table_cell),
            Paragraph("1.00", table_cell),
            Paragraph("0.97", table_cell),
            Paragraph("<b>0.9989</b>", table_cell_bold),
            Paragraph("400", table_cell),
        ],
        [
            Paragraph("<b>Pituitary</b>", table_cell),
            Paragraph("0.99", table_cell),
            Paragraph("0.96", table_cell),
            Paragraph("0.98", table_cell),
            Paragraph("<b>0.9991</b>", table_cell_bold),
            Paragraph("400", table_cell),
        ],
        [
            Paragraph("<b>Macro Average / Total</b>", table_cell_bold),
            Paragraph("<b>0.93</b>", table_cell_bold),
            Paragraph("<b>0.93</b>", table_cell_bold),
            Paragraph("<b>0.92</b>", table_cell_bold),
            Paragraph("<b>0.9812</b>", table_cell_bold),
            Paragraph("<b>1,600</b>", table_cell_bold),
        ],
    ]
    ...
    if os.path.exists(cm_path) and os.path.exists(hist_path):
        ...
        chart_table = Table(
            [
                [
                    Paragraph("<b>Figure 1: Normalized Confusion Matrix</b>", table_cell_bold),
                    Paragraph("<b>Figure 2: Training & Validation Curves</b>", table_cell_bold),
                ],
                [img_cm, img_hist],
            ],
            colWidths=[252, 252],
    ...
    eng_highlights = [
        (
            "<b>Elimination of Test Data Leakage:</b>",
            "The original prototype applied random brightness/contrast augmentations across test evaluations, distorting metrics. The refactored pipeline guarantees clean evaluation on unaltered test images.",
        ),
        (
            "<b>Single Source of Truth (SSOT) Label Encoding:</b>",
            "Labels are derived once via discover_class_names() in alphabetical order, resolving confusion matrix axis misalignments.",
        ),
        (
            "<b>Stratified Validation & Callbacks:</b>",
            "Includes a 15% stratified split, ModelCheckpoint saving exclusively the best validation accuracy weights in modern native .keras format, and CSVLogger.",
        ),
        (
            "<b>Automated Pytest Suite:</b>",
            "25 deterministic unit tests covering data splits, label encodings, augmentation, layer freezing, and single-image inference with 100% pass rate.",
        ),
    ]
    ...
    cli_guide_data = [
        [
            Paragraph("<b>Workflow Task</b>", table_cell_header),
            Paragraph("<b>Windows Batch Command</b>", table_cell_header),
            Paragraph("<b>CLI Command (PowerShell / Bash)</b>", table_cell_header),
        ],
        [
            Paragraph("<b>One-Click Setup</b>", table_cell_bold),
            Paragraph("<code>Double-click setup.bat</code>", table_cell),
            Paragraph(
                "<code>py -3.11 -m venv venv; pip install -r requirements.txt; pip install -e .</code>",
                table_cell,
            ),
        ],
        [
            ...
            Paragraph(
                "<code>python scripts/predict.py --image data/sample/sample_mri.jpg</code>",
                table_cell,
            ),
        ],
        [
            ...
            Paragraph(
                "<code>python scripts/train.py --config configs/config.yaml --epochs 10</code>",
                table_cell,
            ),
        ],
        [
            ...
            Paragraph(
                "<code>python scripts/evaluate.py --config configs/config.yaml</code>", table_cell
            ),
        ],
        [
